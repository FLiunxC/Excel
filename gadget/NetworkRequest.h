...
public:
     ...
     */
    QNetworkReply * doPostRequest(const QString &targetUrl);
    /**
    ...
    * @param targetUrl  请求的目标URL
    */
   QNetworkReply * doGetRequest(const QString &targetUrl);
   /**
    ...
    * @return
    */
   QNetworkReply *uploadFile(const QString &Filepath, QString targetUrl);
